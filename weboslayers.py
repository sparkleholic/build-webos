...
# Supported MACHINE-s
Machines = ['qemux86', 'raspberrypi3', 'raspberrypi4', 'raspberrypi4-64']
...
('meta-updater',              15, 'git://github.com/advancedtelematic/meta-updater.git',    'branch=thud,commit=544eecf', ''),
...
('meta-webos',                40, 'git://github.com/webosose/meta-webosose.git',            'branch=master,commit=2f199dd5', ''),
